...
class jelangjulangController extends Controller
{
  ...
  public function input(Request $req)
  {
    ...
    $model->registrasi($nama, $email, $nomor, $sesi, $bukti, $password);
    //return ke view rincian_order dengan mengirim sesi dan data order
    $model = new jelangjulangModel();
  ...
  //menampilkan qrcode setelah update data diri
  public function qrcode()
  {
    ...
    $qrcode = QrCode::generate('.../info/' . $no_pendaftaran);
    session(['qr' => $qrcode]);
    return view('tiket')
      ->with('sesi', $sesi);
  }
  //login admin untuk melihat password  pelanggan
